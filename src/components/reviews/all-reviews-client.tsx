        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative z-10 max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-3xl border border-[#E5E2DA] bg-[#FBFAF7] p-6 shadow-2xl [scrollbar-width:thin] sm:p-8 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-neutral-300 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:w-1.5 dark:border-[#2A3241] dark:bg-[#12161F] dark:[&::-webkit-scrollbar-thumb]:bg-neutral-700"
            >
              {/* 2px Gradient Top Accent */}
              <div className="absolute left-0 right-0 top-0 h-[2px] bg-brand-gradient" />
              ...
              <button
                type="button"
                onClick={() => setIsModalOpen(false)}
                className="absolute right-5 top-5 rounded-full p-1.5 text-neutral-400 transition-colors hover:bg-neutral-200/60 hover:text-neutral-700 dark:hover:bg-neutral-800 dark:hover:text-white"
              >
